...
if (contactForm) {
  contactForm.addEventListener('submit', (event) => {
    ...
    alert('This is a static demo form. Connect it to your preferred backend or form handler for live barber shop bookings.');
  });
}
...
const themeStorageKey = 'barber-shop-template-theme';
