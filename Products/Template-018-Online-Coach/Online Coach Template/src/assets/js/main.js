...
if (contactForm) {
  contactForm.addEventListener('submit', (event) => {
    ...
    alert('This is a static demo form. Connect it to your preferred backend, booking tool, or form handler for live coaching enquiries and lead capture.');
  });
}

const themes = [
  { id: 'plum-authority', label: 'Plum Authority' },
  { id: 'forest-ledger', label: 'Forest Ledger' },
  { id: 'navy-lift', label: 'Navy Lift' },
  { id: 'coral-momentum', label: 'Coral Momentum' },
  { id: 'soft-light', label: 'Soft Light' }
];

const themeButtons = document.querySelectorAll('[data-theme-option]');
const themeCurrentName = document.getElementById('theme-current-name');
const themeStorageKey = 'online-coach-template-theme';
