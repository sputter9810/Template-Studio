...
if (contactForm) {
  contactForm.addEventListener('submit', (event) => {
    ...
    alert('This is a static demo form. Connect it to your preferred ordering flow, inbox, backend, or form handler for live enquiries.');
  });
}

const themes = [
  { id: 'rush-red', label: 'Rush Red' },
  { id: 'midnight-navy', label: 'Midnight Navy' },
  { id: 'soy-lime', label: 'Soy Lime' },
  { id: 'charcoal-cream', label: 'Charcoal Cream' },
  { id: 'chilli-mango', label: 'Chilli Mango' }
];

const themeButtons = document.querySelectorAll('[data-theme-option]');
const themeCurrentName = document.getElementById('theme-current-name');
const themeStorageKey = 'takeaway-template-theme';
