...
const themes = [
  { id: 'olive-coast', label: 'Olive Coast' },
  { id: 'terracotta-dusk', label: 'Terracotta Dusk' },
  { id: 'ocean-retreat', label: 'Ocean Retreat' },
  { id: 'sandstone', label: 'Sandstone' },
  { id: 'night-cabin', label: 'Night Cabin' }
];

const themeButtons = document.querySelectorAll('[data-theme-option]');
const themeCurrentName = document.getElementById('theme-current-name');
const themeStorageKey = 'holiday-rental-template-theme';
