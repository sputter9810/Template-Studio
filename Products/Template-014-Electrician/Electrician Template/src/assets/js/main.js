...
const themes = [
  ...
  { id: 'safety-orange', label: 'Signal Amber' },
  { id: 'steel-grey', label: 'Graphite' },
  { id: 'forest', label: 'Electric Blue' },
  { id: 'black-gold', label: 'Blackout' }
];

const themeButtons = document.querySelectorAll('[data-theme-option]');
const themeCurrentName = document.getElementById('theme-current-name');
const themeStorageKey = 'electrician-template-theme';
