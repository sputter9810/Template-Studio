...
3. Change the colour variables
4. Replace the hero and gallery imagery
5. Rewrite the services and trust sections for the chosen niche
6. Connect the form if needed

## Theme selector
This template includes a built-in theme selector panel with five colour schemes: Midnight, Signal Amber, Graphite, Electric Blue, Blackout.
