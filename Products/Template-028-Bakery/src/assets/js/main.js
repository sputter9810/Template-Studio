...
if (contactForm) {
  contactForm.addEventListener('submit', (event) => {
    ...
    alert('This is a static demo form. Connect it to your preferred inbox, CRM, backend, or form handler for live enquiries.');
  });
}
...
const themes = [
  ...
  { id: 'berry-jam', label: 'Berry Jam' },
  { id: 'sage-linen', label: 'Sage Linen' },
  { id: 'charcoal-cafe', label: 'Charcoal Cafe' }
];

const themeButtons = document.querySelectorAll('[data-theme-option]');
const themeCurrentName = document.getElementById('theme-current-name');
const themeStorageKey = 'bakery-template-theme';
