...
if (contactForm) {
  contactForm.addEventListener('submit', (event) => {
    ...
    alert('This is a static demo form. Connect it to your preferred inbox, booking platform, CRM, backend, or form handler for live reservations.');
  });
}

const themes = [
  { id: 'midnight-olive', label: 'Midnight Olive' },
  { id: 'ivory-noir', label: 'Ivory Noir' },
  { id: 'merlot-brass', label: 'Merlot Brass' },
  { id: 'stone-velvet', label: 'Stone Velvet' },
  { id: 'sage-champagne', label: 'Sage Champagne' }
];

const themeButtons = document.querySelectorAll('[data-theme-option]');
const themeCurrentName = document.getElementById('theme-current-name');
const themeStorageKey = 'fine-dining-template-theme';
