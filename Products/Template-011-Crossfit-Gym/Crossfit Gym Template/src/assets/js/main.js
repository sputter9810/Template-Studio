...
if (contactForm) {
  contactForm.addEventListener('submit', (event) => {
    ...
    alert('This is a static demo form. Connect it to your preferred backend or form handler for live trial bookings.');
  });
}

const themes = [
  { id: 'ember', label: 'Ember' },
  { id: 'toxic-lime', label: 'Toxic Lime' },
  { id: 'competition-red', label: 'Competition Red' },
...
const themeStorageKey = 'crossfit-gym-template-theme';
