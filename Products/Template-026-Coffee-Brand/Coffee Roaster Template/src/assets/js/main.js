...
if (contactForm) {
  contactForm.addEventListener('submit', (event) => {
    ...
    alert('This is a static demo form. Connect it to your preferred ecommerce flow, CRM, backend, or form handler for live enquiries.');
  });
}
...
const themeStorageKey = 'coffee-roaster-template-theme';
