...
const themes = [
  { id: 'graphite-lime', label: 'Graphite Lime' },
  { id: 'urban-teal', label: 'Urban Teal' },
  { id: 'steel-mint', label: 'Steel Mint' },
  { id: 'night-heat', label: 'Night Heat' },
  { id: 'chalk-studio', label: 'Chalk Studio' }
];

const themeButtons = document.querySelectorAll('[data-theme-option]');
const themeCurrentName = document.getElementById('theme-current-name');
const themeStorageKey = 'calisthenics-gym-template-theme';
