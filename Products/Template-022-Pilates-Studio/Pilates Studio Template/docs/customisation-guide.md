...
## Images
Replace the placeholder panels in `src/index.html` with real studio, reformer, teacher, or class photography when needed.

## Form
The booking enquiry form is static by default. Connect it to your preferred backend or form service before going live.
